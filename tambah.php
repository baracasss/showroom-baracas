...
if (!empty($_POST)) {
	...
	$query = mysqli_query($koneksi, "INSERT INTO mobil (nama, deskripsi, merk, gambar, harga) VALUES ('$nama','$deskripsi','$merk','$gambar','$harga')");
...
<body>
	<form method="POST">
		...
		<input type="text" name="nama_mobil" id="nama">

		<label for="deskripsi">Deskripsi Mobil:</label>
		<textarea name="deskripsi_mobil" id="deskripsi"></textarea>
